...
ES_HTML_HOST_SED=${ES_HTML_HOST//\//\\\/}
ES_HTML_HOST_SED=${ES_HTML_HOST_SED//\./\\\.}
ES_HOST_SED=${ES_HOST//\//\\\/}
ES_HOST_SED=${ES_HOST//\./\\\.}
...
sed -i "s/server_name es_html;/server_name $ES_HTML_HOST;/g" /etc/nginx/sites/es_html.conf
...
sed -i "s/user = www-data/user = es_html/g" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = es_html/g" /etc/php/7.4/fpm/pool.d/www.conf
...
sed -i "s/listen.owner = www-data/listen.owner = es_html/g" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/listen.group = www-data/listen.group = es_html/g" /etc/php/7.4/fpm/pool.d/www.conf
sed -i "s/;catch_workers_output = yes/catch_workers_output = yes/g" /etc/php/7.4/fpm/pool.d/www.conf

sed -i "s/ES_HOST/$ES_HOST_SED/g" /opt/es_html/src/Resource/config/resources_shared.php
sed -i "s/ES_PORT/$ES_PORT/g" /opt/es_html/src/Resource/config/resources_shared.php
sed -i "s/ES_HTML_HOST/$ES_HTML_HOST_SED/g" /opt/es_html/src/Gateway.php
